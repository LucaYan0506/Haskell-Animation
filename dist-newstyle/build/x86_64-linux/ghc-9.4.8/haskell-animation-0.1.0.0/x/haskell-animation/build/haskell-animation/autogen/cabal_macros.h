...
/* package haskell-animation-0.1.0.0 */
#ifndef VERSION_haskell_animation
#define VERSION_haskell_animation "0.1.0.0"
#endif /* VERSION_haskell_animation */
#ifndef MIN_VERSION_haskell_animation
#define MIN_VERSION_haskell_animation(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_animation */
...
#define CURRENT_COMPONENT_ID "haskell-animation-0.1.0.0-inplace-haskell-animation"
